...
import org.dynasite.page.JSPage;
...
public class TestJSPages {
    ...
    @Test
    public void testJSPages() throws IOException {
                        ...
                        new HashMap<>() {
                            {
                                ...
                                put("/js", JSPage.getFromResource("/test-sites/js-pages/test-script.js"));
                            }
                        }
                ),
                stopServer
